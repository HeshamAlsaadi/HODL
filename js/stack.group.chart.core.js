 ...
 */
d3.csv("data/stacked_data.csv", addTotalsColumn, function(error, data) {
    ...
    rect.append("svg:title")
        .text(function(d) {
            return d.state + ", " + d.ageGroup + ": " + d.y + " (total: " + d.total + ")";
        });
...
function transitionGrouped() {
    ...
    rect.transition()
        ...
        .attr("x", function(d) {
            return x(d.state) + 0.5 + columns.indexOf(d.ageGroup) * (x.bandwidth() / columns.length);
        })
